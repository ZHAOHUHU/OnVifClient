 ...
 **/
@Component
public class CommondHandlerRefact {
    //Class<?> c = null;
    //@Value("${request.url}")
    //private String url;
    //@Autowired
    ...
    //
    //
    //public CommondHandlerRefact() {
    //    try {
    //        c = Class.forName("shenzhen.teamway.model.CommondHandlerRefact");
    //
    ...
    //}
    //
    //public String invokeMethod(String methodName, String s) {
    //    try {
    //        Method method = c.getMethod(methodName, String.class);
    //        final Object o = c.newInstance();
    //        String str = (String) method.invoke(o, new Object[]{s});
    //        return str;
